        ...
        <tbody>
            @foreach ($audits as $audit)
                ...
                <td class="p-3 border border-r border-gray-50 text-center">
                    <a class="flex" href="{{ route('audit.edit', ['audit' => $audit->id, 'print' => true]) }}">
                ...
                <td class="p-3 border border-r border-gray-50">
                    ...
                    <a href="{{ route('audit.edit', $audit->id) }}" class="btn btn-xs text-sm">
                ...
                <td class="p-3 border border-r border-gray-50">
                    {{ $audit->AuditItems->where('non_conformity',1)->where('closed',1)->count() }}
                    out of
                    {{ $audit->AuditItems->where('non_conformity')->count() }}
                    Closed

                </td>
                <td class="p-3 border border-r border-gray-50">

                    <a href="{{ route('audit.review', $audit->id) }}" class="btn btn-xs ">
