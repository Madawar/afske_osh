                ...
                <nav class=" ">
                    ...
                    <div>
                        ...
                        <a class="sidebar-item " href="/">
                            <span class="text-left">
                                <svg class="h-6 w-6" id="Layer_1_1_" style="enable-background:new 0 0 16 16;"
                    ...
                    <div>
                        ...
                        <a class="sidebar-item {{ request()->is('checklist') ? 'bg-gray-100' : '' }}"
                            href="{{ action([ChecklistController::class, 'index']) }}">
                            <span class="text-left">
                                <svg enable-background="new 0 0 128 128" class="h-6 w-6" id="Layer_1"
                                    version="1.1" viewBox="0 0 128 128" width="128px" xml:space="preserve"
                                    xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                    <g>
                                        <g>
                                            <path
                                                d="M104,24H93.781c-2.773-4.766-7.875-8-13.781-8c0-8.836-7.164-16-16-16S48,7.164,48,16    c-5.906,0-11.008,3.234-13.783,8H24c-8.836,0-16,7.164-16,16v72c0,8.836,7.164,16,16,16h80c8.836,0,16-7.164,16-16V40    C120,31.164,112.836,24,104,24z M40,32c0-4.414,3.586-8,8-8h8v-8c0-4.414,3.586-8,8-8s8,3.586,8,8v8h8c4.414,0,8,3.586,8,8v8H40    V32z M96,48v56H32V48H96z M112,112c0,4.414-3.586,8-8,8H24c-4.414,0-8-3.586-8-8V40c0-4.414,3.586-8,8-8h8v8h-8v72h80V40h-8v-8h8    c4.414,0,8,3.586,8,8V112z M72,32v-8H56v8H72z"
                                                fill="#546E7A" />
                                        </g>
                                    </g>
                                    <path d="M88,56H40v8h48V56z" fill="#B0BEC5" />
                                    <path d="M88,72H40v8h48V72z" fill="#B0BEC5" />
                                    <path d="M64,88H40v8h24V88z" fill="#B0BEC5" />
                                </svg>
                            </span>
                            <span class="mx-4 text-md font-normal">
                                Checklists
                    ...
                    @if (Auth::user()->account_type == 'osh')
                        <div>
                            ...
                            <a class="sidebar-item {{ request()->is('factor') ? 'bg-gray-100' : '' }}" href="/factor">
                                <span class="text-left">
                                    <svg class="h-6 w-6" data-name="Слой 1" id="Слой_1" viewBox="0 0 128 128"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <title />
                                        <path
                                            d="M126,120H2a2,2,0,0,1-1.73-3l62-108a2,2,0,0,1,3.46,0l62,108a2,2,0,0,1-1.73,3ZM5.45,116h117.1L64,14Z" />
                                        <path
                                            d="M64,108a8.81,8.81,0,1,1,8.81-8.81A8.82,8.82,0,0,1,64,108Zm0-13.62a4.81,4.81,0,1,0,4.81,4.81A4.82,4.82,0,0,0,64,94.38Z" />
                                        <path
                                            d="M64,86.33a8.82,8.82,0,0,1-8.81-8.81V52.81a8.81,8.81,0,0,1,17.62,0V77.52A8.82,8.82,0,0,1,64,86.33ZM64,48a4.82,4.82,0,0,0-4.81,4.81V77.52a4.81,4.81,0,0,0,9.62,0V52.81A4.82,4.82,0,0,0,64,48Z" />
                                    </svg>
                                </span>
                                <span class="mx-4 text-md font-normal">
                                    Incident Factors
