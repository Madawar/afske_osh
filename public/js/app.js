...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var winbox_src_js_winbox__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! winbox/src/js/winbox */ "./node_modules/winbox/src/js/winbox.js");
...
window.WinBox = winbox_src_js_winbox__WEBPACK_IMPORTED_MODULE_0__.default;
...
/***/ "./node_modules/winbox/src/js/template.js":
/*!************************************************!*\
  !*** ./node_modules/winbox/src/js/template.js ***!
  \************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/***/ "./node_modules/winbox/src/js/winbox.js":
/*!**********************************************!*\
  !*** ./node_modules/winbox/src/js/winbox.js ***!
  \**********************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _template_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./template.js */ "./node_modules/winbox/src/js/template.js");
/* harmony import */ var _helper_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./helper.js */ "./node_modules/winbox/src/js/helper.js");
/**
 * WinBox.js
...
function WinBox(params, _title){
    ...
    this.dom = (0,_template_js__WEBPACK_IMPORTED_MODULE_0__.default)();
    this.body = (0,_helper_js__WEBPACK_IMPORTED_MODULE_1__.getByClass)(this.dom, "wb-body");
    ...
    if(params){
        ...
        if(typeof params === "string"){
            ...
            if(border){
                ...
                (0,_helper_js__WEBPACK_IMPORTED_MODULE_1__.setStyle)(this.body, "margin", border + (isNaN(border) ? "" : "px"));
            }
        }
    }
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (WinBox);
...
function setup(){
    ...
    (0,_helper_js__WEBPACK_IMPORTED_MODULE_1__.addListener)(window, "resize", function(){
...
function register(self){
    ...
    (0,_helper_js__WEBPACK_IMPORTED_MODULE_1__.addListener)((0,_helper_js__WEBPACK_IMPORTED_MODULE_1__.getByClass)(self.dom, "wb-min"), "click", function(event){

        (0,_helper_js__WEBPACK_IMPORTED_MODULE_1__.preventEvent)(event);
        self.minimize();
    });

    (0,_helper_js__WEBPACK_IMPORTED_MODULE_1__.addListener)((0,_helper_js__WEBPACK_IMPORTED_MODULE_1__.getByClass)(self.dom, "wb-max"), "click", function(event){
    ...
    if(prefix_request){
        ...
        (0,_helper_js__WEBPACK_IMPORTED_MODULE_1__.addListener)((0,_helper_js__WEBPACK_IMPORTED_MODULE_1__.getByClass)(self.dom, "wb-full"), "click", function(event){
    ...
    (0,_helper_js__WEBPACK_IMPORTED_MODULE_1__.addListener)((0,_helper_js__WEBPACK_IMPORTED_MODULE_1__.getByClass)(self.dom, "wb-close"), "click", function(event){

        (0,_helper_js__WEBPACK_IMPORTED_MODULE_1__.preventEvent)(event);
        self.close() || (self = null);
    });

    (0,_helper_js__WEBPACK_IMPORTED_MODULE_1__.addListener)(self.dom, "click", function(event){
...
function disable_animation(self){
    ...
    (0,_helper_js__WEBPACK_IMPORTED_MODULE_1__.setStyle)(self.dom, "transition", "none");
}
...
function enable_animation(self){
    ...
    (0,_helper_js__WEBPACK_IMPORTED_MODULE_1__.setStyle)(self.dom, "transition", "");
}
...
function addWindowListener(self, dir){
    ...
    const node = (0,_helper_js__WEBPACK_IMPORTED_MODULE_1__.getByClass)(self.dom, "wb-" + dir);
    let touch, x, y;

    (0,_helper_js__WEBPACK_IMPORTED_MODULE_1__.addListener)(node, "mousedown", mousedown);
    (0,_helper_js__WEBPACK_IMPORTED_MODULE_1__.addListener)(node, "touchstart", mousedown, { "passive": false });
    ...
    function mousedown(event){
        ...
        (0,_helper_js__WEBPACK_IMPORTED_MODULE_1__.preventEvent)(event, true);
        ...
        if(self.min){
            ...
            if((touch = event.touches) && (touch = touch[0])){
                ...
                (0,_helper_js__WEBPACK_IMPORTED_MODULE_1__.addListener)(window, "touchmove", handler_mousemove);
                (0,_helper_js__WEBPACK_IMPORTED_MODULE_1__.addListener)(window, "touchend", handler_mouseup);
            }
            else{

                //addListener(this, "mouseleave", handler_mouseup);
                (0,_helper_js__WEBPACK_IMPORTED_MODULE_1__.addListener)(window, "mousemove", handler_mousemove);
                (0,_helper_js__WEBPACK_IMPORTED_MODULE_1__.addListener)(window, "mouseup", handler_mouseup);
            }
    ...
    function handler_mouseup(event){
        ...
        if(touch){
            ...
            (0,_helper_js__WEBPACK_IMPORTED_MODULE_1__.removeListener)(window, "touchmove", handler_mousemove);
            (0,_helper_js__WEBPACK_IMPORTED_MODULE_1__.removeListener)(window, "touchend", handler_mouseup);
        }
        else{

            (0,_helper_js__WEBPACK_IMPORTED_MODULE_1__.removeListener)(window, "mousemove", handler_mousemove);
            (0,_helper_js__WEBPACK_IMPORTED_MODULE_1__.removeListener)(window, "mouseup", handler_mouseup);
        }
    }
}
...
WinBox.prototype.setTitle = function(title){
    ...
    (0,_helper_js__WEBPACK_IMPORTED_MODULE_1__.setText)((0,_helper_js__WEBPACK_IMPORTED_MODULE_1__.getByClass)(this.dom, "wb-title"), this.title = title);
    return this;
};
...
WinBox.prototype.setBackground = function(background){
    ...
    (0,_helper_js__WEBPACK_IMPORTED_MODULE_1__.setStyle)(this.dom, "background", background);
    return this;
};
...
WinBox.prototype.focus = function(){
    ...
    if(last_focus !== this){
        ...
        (0,_helper_js__WEBPACK_IMPORTED_MODULE_1__.setStyle)(this.dom, "z-index", index++);
        this.addClass("focus");
...
WinBox.prototype.move = function(x, y, _skip_update){
    ...
    (0,_helper_js__WEBPACK_IMPORTED_MODULE_1__.setStyle)(this.dom, "transform", "translate(" + x + "px," + y + "px)");
...
WinBox.prototype.resize = function(w, h, _skip_update){
    ...
    (0,_helper_js__WEBPACK_IMPORTED_MODULE_1__.setStyle)(this.dom, "width", w + "px");
    (0,_helper_js__WEBPACK_IMPORTED_MODULE_1__.setStyle)(this.dom, "height", h + "px");
...
WinBox.prototype.addClass = function(classname){
    ...
    (0,_helper_js__WEBPACK_IMPORTED_MODULE_1__.addClass)(this.dom, classname);
    return this;
};
...
WinBox.prototype.removeClass = function(classname){
    ...
    (0,_helper_js__WEBPACK_IMPORTED_MODULE_1__.removeClass)(this.dom, classname);
    return this;
};
